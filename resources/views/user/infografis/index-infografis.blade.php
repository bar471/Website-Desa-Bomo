...
@section('content')
<div class="mt-8 mb-20"> <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900">INFOGRAFIS</h1>
        ...
        <div class="{{ $box }}">
            ...
            <div class="grid grid-cols-2 gap-10 relative text-center">
                ...
                <div class="flex flex-col items-center z-10 bg-white py-2">
                    <img src="{{ asset('assets/icons/sd-mi.png') }}" class="w-16 mb-3">
                    <p class="text-xl font-bold text-gray-900">2 SD/MI</p>
                </div>
                <div class="flex flex-col items-center z-10 bg-white py-2">
                    <img src="{{ asset('assets/icons/smp-mts.png') }}" class="w-16 mb-3">
                    <p class="text-xl font-bold text-gray-900">1 SMP/MTS</p>
                </div>
                <div class="flex flex-col items-center z-10 bg-white py-2">
                    <img src="{{ asset('assets/icons/masjid.png') }}" class="w-16 mb-3">
                    <p class="text-xl font-bold text-gray-900">2 MASJID</p>
                </div>
                <div class="flex flex-col items-center z-10 bg-white py-2">
                    <img src="{{ asset('assets/icons/mushola.png') }}" class="w-16 mb-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-10 text-center place-items-center">
                <a href="{{ route('wisata') }}" class="flex flex-col items-center group">
                    <div class="w-36 h-36 rounded-full bg-green-100 shadow-inner group-hover:bg-green-200 transition flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('assets/images/wisata-thumb.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-300" alt="Pantai Bomo">
                    </div>
                ...
                <a href="{{ route('perikanan') }}" class="flex flex-col items-center group">
                    <div class="w-36 h-36 rounded-full bg-green-100 shadow-inner group-hover:bg-green-200 transition flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('assets/images/perikanan-thumb.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-300" alt="Perikanan">
                    </div>
                ...
                <a href="{{ route('pertanian') }}" class="flex flex-col items-center group">
                    <div class="w-36 h-36 rounded-full bg-green-100 shadow-inner group-hover:bg-green-200 transition flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('assets/images/pertanian-thumb.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-300" alt="Pertanian">
                    </div>
