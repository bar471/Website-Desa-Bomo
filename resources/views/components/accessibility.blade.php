...
<div class="accessibility-wrapper">
    <button @click="akses = !akses"
        class="position:fixed bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-lg hover:bg-green-700 active:scale-95 transition duration-200 focus:outline-none focus:ring-2 focus:ring-green-400"
...
<div x-show="akses" x-transition:enter="transition ease-out duration-200"
    ...
    <button @click="invert = !invert"
        class="position:fixed w-full text-left px-3 py-2 text-sm sm:text-base rounded-md border border-gray-300 hover:bg-gray-100 focus:ring-2 focus:ring-green-400 transition">
        Balik Warna
    </button>
